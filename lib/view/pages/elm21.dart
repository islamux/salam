import 'package:elm/cubit/pages_cubits/elm21_cubit.dart'; // Import the Elm21Cubit
          ...
          return Scaffold(
            appBar: AppBar(
              ...
              actions: [
                IconButton(
                  onPressed: () {
                    context.read<Elm21Cubit>().decreaseFontSize(); // Decrease font size
                  },
                ...
                IconButton(
                  onPressed: () {
                    context.read<Elm21Cubit>().increaseFontSize(); // Increase font size
                  },
