...
class Elm21 extends StatelessWidget {
  const Elm21({super.key});

  @override
  Widget build(BuildContext context) {
    final Elm21ControllerImp controller = Get.find<Elm21ControllerImp>();
    //Elm21ControllerImp controller = Get.put(AthkarSabahControllerImp());
    return Scaffold(
      appBar: AppBar(
        ...
        leading: GestureDetector(
          onTap: () {
            ...
            Get.find<Elm21ControllerImp>().resetCounter();
        ...
        actions: [
          ...
          // Font between + -Elm21ControllerImp
          const Row(
