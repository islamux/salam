...
import 'package:elm/view/widget/custom_text_slider/custom_text_slider_elm12.dart';
import 'package:flutter/material.dart';
import 'package:get/get.dart';

class Elm12 extends StatelessWidget {
  const Elm12({super.key});

  @override
  Widget build(BuildContext context) {
    final Elm12ControllerImp controllerAs = Get.find<Elm12ControllerImp>();
    //Elm12ControllerImp controllerAs = Get.put(AthkarSabahControllerImp());
    return Scaffold(
      appBar: AppBar(
        ...
        leading: GestureDetector(
          onTap: () {
            ...
            Get.find<Elm12ControllerImp>().resetCounter();
