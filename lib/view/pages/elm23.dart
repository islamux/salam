...
import 'package:khatir/cubit/elm_cubits/elm_23_cubit.dart';
...
class Elm23Page extends StatelessWidget {
  ...
  const Elm23Page({super.key, this.initialPage});

  @override
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) {
        final cubit = Elm23Cubit();
                ...
                children: [
                  Expanded(
                    child: GenericCustomTextSlider( // Changed
                      cubit: context.read<Elm23Cubit>(),
                      dataList: elmList23NewOrder,
