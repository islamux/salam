import 'package:elm/cubit/pages_cubits/elm23_cubit.dart'; // Import the Elm23Cubit
          ...
          return Scaffold(
            appBar: AppBar(
              ...
              actions: [
                IconButton(
                  onPressed: () {
                    context.read<Elm23Cubit>().decreaseFontSize(); // Decrease font size
                  },
                ...
                IconButton(
                  onPressed: () {
                    context.read<Elm23Cubit>().increaseFontSize(); // Increase font size
                  },
