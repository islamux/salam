...
import 'package:khatir/cubit/elm_cubits/elm_15_cubit.dart';
...
class Elm15Page extends StatelessWidget {
  ...
  const Elm15Page({super.key, this.initialPage});

  @override
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) {
        final cubit = Elm15Cubit();
                ...
                children: [
                  Expanded(
                    child: GenericCustomTextSlider( // Changed
                      cubit: context.read<Elm15Cubit>(),
                      dataList: elmList15NewOrder,
