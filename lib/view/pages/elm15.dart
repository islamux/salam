import 'package:elm/cubit/pages_cubits/elm15_cubit.dart'; // Import the Elm15Cubit
          ...
          return Scaffold(
            appBar: AppBar(
              ...
              actions: [
                IconButton(
                  onPressed: () {
                    context.read<Elm15Cubit>().decreaseFontSize(); // Decrease font size
                  },
                ...
                IconButton(
                  onPressed: () {
                    context.read<Elm15Cubit>().increaseFontSize(); // Increase font size
                  },
