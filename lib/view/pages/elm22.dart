import 'package:elm/cubit/pages_cubits/elm22_cubit.dart'; // Import the Elm22Cubit
          ...
          return Scaffold(
            appBar: AppBar(
              ...
              actions: [
                IconButton(
                  onPressed: () {
                    context.read<Elm22Cubit>().decreaseFontSize(); // Decrease font size
                  },
                ...
                IconButton(
                  onPressed: () {
                    context.read<Elm22Cubit>().increaseFontSize(); // Increase font size
                  },
