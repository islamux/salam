...
import 'package:elm/view/widget/custom_text_slider/custom_text_slider_elm8.dart';
import 'package:flutter/material.dart';
import 'package:get/get.dart';

class Elm8 extends StatelessWidget {
  const Elm8({super.key});

  @override
  Widget build(BuildContext context) {
    //ElmPageControllerImp controllerM = Get.put(AthkarMassaControllerImp());
    final controllerM = Get.find<Elm8ControllerImp>();
    ...
    return Scaffold(
      ...
      body: SafeArea(
        child: GestureDetector(
            ...
            child: const CustomTextSliderElm8()),
      ),
    );
  }
}
