import 'package:elm/cubit/pages_cubits/elm8_cubit.dart'; // Import Elm8Cubit
          ...
          return Scaffold(
            appBar: AppBar(
              ...
              actions: [
                IconButton(
                  onPressed: () {
                    context.read<Elm8Cubit>().decreaseFontSize(); // Decrease font size
                  },
                ...
                IconButton(
                  onPressed: () {
                    context.read<Elm8Cubit>().increaseFontSize(); // Increase font size
                  },
