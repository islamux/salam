          ...
          return Scaffold(
            appBar: AppBar(
                  ...
                  IconButton(
                    ...
                    onPressed: () {
                      final currentPageIndex =
                          context.read<Khatira25Cubit>().currentPageIndex;
                      context.read<Khatira25Cubit>().customShareContent(
                          currentPageIndex, khatiraList25NewOrder);
                    },
              ...
              leading: GestureDetector(
                onTap: () {
                  context.read<Khatira25Cubit>().resetCounter(); // Reset counter
                  // Navigator.pushNamed(
                ...
                children: [
                  Expanded(
                    child: GenericCustomTextSlider( // Changed
                      cubit: context.read<Khatira25Cubit>(),
