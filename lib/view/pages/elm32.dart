import 'package:elm/core/data/model/elm_lists/elm_list_32_new_order.dart';
import 'package:elm/core/data/static/routes_constant.dart';
import 'package:elm/core/data/static/theme/app_color_constant.dart';
import 'package:elm/cubit/elm_cubits/elm_32_cubit.dart';
...
class Elm32Page extends StatelessWidget {
  const Elm32Page({super.key});

  @override
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => Elm32Cubit(),
      child: Builder(
        builder: (context) {
          return Scaffold(
            appBar: AppBar(
