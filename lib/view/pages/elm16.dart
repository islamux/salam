...
import 'package:khatir/cubit/elm_cubits/elm_16_cubit.dart';
...
class Elm16Page extends StatelessWidget {
  ...
  const Elm16Page({super.key, this.initialPage});

  @override
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) {
        final cubit = Elm16Cubit();
                ...
                children: [
                  IconButton(
                    ...
                    onPressed: () {
                      ...
                      context.read<Elm16Cubit>().customShareContent(
                          currentPageIndex, elmList16NewOrder);
                    },
                ...
                children: [
                  Expanded(
                    child: GenericCustomTextSlider( // Changed
                      cubit: context.read<Elm16Cubit>(),
                      dataList: elmList16NewOrder,
