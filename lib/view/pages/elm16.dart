import 'package:elm/cubit/pages_cubits/elm16_cubit.dart'; // Import the Elm16Cubit
          ...
          return Scaffold(
            appBar: AppBar(
              ...
              actions: [
                IconButton(
                  onPressed: () {
                    context.read<Elm16Cubit>().decreaseFontSize(); // Decrease font size
                  },
                ...
                IconButton(
                  onPressed: () {
                    context.read<Elm16Cubit>().increaseFontSize(); // Increase font size
                  },
