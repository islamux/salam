          ...
          return Scaffold(
            appBar: AppBar(
                  ...
                  IconButton(
                    ...
                    onPressed: () {
                      final currentPageIndex =
                          context.read<Khatira23Cubit>().currentPageIndex;
                      context.read<Khatira23Cubit>().customShareContent(
                          currentPageIndex, khatiraList23NewOrder);
                    },
              ...
              leading: GestureDetector(
                onTap: () {
                  context.read<Khatira23Cubit>().resetCounter(); // Reset counter
                  // Navigator.pushNamed(
                ...
                children: [
                  Expanded(
                    child: GenericCustomTextSlider( // Changed
                      cubit: context.read<Khatira23Cubit>(),
