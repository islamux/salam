import 'package:elm/cubit/pages_cubits/elm5_cubit.dart'; // Import Elm5Cubit
          ...
          return Scaffold(
            appBar: AppBar(
              ...
              leading: GestureDetector(
                onTap: () {
                  context.read<Elm5Cubit>().resetCounter(); // Reset counter before going back
              ...
              actions: [
                IconButton(
                  onPressed: () {
                    context.read<Elm5Cubit>().decreaseFontSize(); // Decrease font size
                  },
                ...
                IconButton(
                  onPressed: () {
                    context.read<Elm5Cubit>().increaseFontSize(); // Increase font size
                  },
