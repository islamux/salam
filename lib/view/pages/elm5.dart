...
import 'package:khatir/cubit/elm_cubits/elm_5_cubit.dart';
...
class Elm5Page extends StatelessWidget {
  ...
  const Elm5Page({super.key, this.initialPage});

  @override
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) {
        final cubit = Elm5Cubit();
            ...
            body: SafeArea(
              child: GestureDetector( // GestureDetector can likely be removed if not needed for other purposes
                ...
                child: GenericCustomTextSlider( // Changed
                  cubit: context.read<Elm5Cubit>(),
                  dataList: elmList5NewOrder,
