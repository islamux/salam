...
class Khatira9Page extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) {
        final cubit = Khatira9Cubit();
        if (initialPage != null && initialPage! > 0) {
          cubit.goToPageAfterBuild(initialPage!);
        }
        return cubit;
      }, // Provide Khatira9Cubit
      child: Builder(
        builder: (context) {
          return Scaffold(
            appBar: AppBar(
                  ...
                  IconButton(
                    ...
                    onPressed: () {
                      final currentPageIndex =
                          context.read<Khatira9Cubit>().currentPageIndex;
                      context.read<Khatira9Cubit>().customShareContent(
                          currentPageIndex, khatiraList9NewOrder);
                    },
              ...
              leading: GestureDetector(
                onTap: () {
                  context.read<Khatira9Cubit>().resetCounter(); // Reset counter
                ...
                children: [
                  Expanded(
                    child: GenericCustomTextSlider(
                      // Changed
                      cubit: context.read<Khatira9Cubit>(),
