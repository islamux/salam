import 'package:elm/cubit/pages_cubits/elm14_cubit.dart'; // Import the Elm14Cubit
          ...
          return Scaffold(
            appBar: AppBar(
              ...
              actions: [
                IconButton(
                  onPressed: () {
                    context.read<Elm14Cubit>().decreaseFontSize(); // Decrease font size
                  },
                ...
                IconButton(
                  onPressed: () {
                    context.read<Elm14Cubit>().increaseFontSize(); // Increase font size
                  },
