...
import 'package:khatir/cubit/khatira_cubits/khatira_6_cubit.dart';
...
class Khatira6Page extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) {
        final cubit = Khatira6Cubit();
        if (initialPage != null && initialPage! > 0) {
          cubit.goToPageAfterBuild(initialPage!);
        }
        return cubit;
      }, // Provide Khatira6Cubit
      child: Builder(
        builder: (context) {
          return Scaffold(
            appBar: AppBar(
                  ...
                  IconButton(
                    ...
                    onPressed: () {
                      final currentPageIndex =
                          context.read<Khatira6Cubit>().currentPageIndex;
                      context.read<Khatira6Cubit>().customShareContent(
                          currentPageIndex, khatiraList6NewOrder);
                    },
            ...
            body: SafeArea(
              child: GestureDetector( // GestureDetector can likely be removed if not needed for other purposes
                ...
                child: GenericCustomTextSlider( // Changed
                  cubit: context.read<Khatira6Cubit>(),
