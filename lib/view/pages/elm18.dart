import 'package:elm/cubit/pages_cubits/elm18_cubit.dart'; // Import the Elm18Cubit
          ...
          return Scaffold(
            appBar: AppBar(
              ...
              leading: GestureDetector(
                onTap: () {
                  context.read<Elm18Cubit>().resetCounter(); // Reset counter
              ...
              actions: [
                IconButton(
                  onPressed: () {
                    context.read<Elm18Cubit>().decreaseFontSize(); // Decrease font size
                  },
                ...
                IconButton(
                  onPressed: () {
                    context.read<Elm18Cubit>().increaseFontSize(); // Increase font size
                  },
            ...
            body: const SafeArea(
              child: Column(
                children: [
                  Expanded(
                    child: CustomTextSliderElm18(), // Custom text slider
                  ),
