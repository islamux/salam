          ...
          return Scaffold(
            appBar: AppBar(
                  ...
                  IconButton(
                    onPressed: () {
                      final currentPageIndex =
                          context.read<Khatira28Cubit>().currentPageIndex;
                      context.read<Khatira28Cubit>().customShareContent(
                          currentPageIndex, khatiraList28NewOrder);
                    },
              ...
              leading: GestureDetector(
                onTap: () {
                  context.read<Khatira28Cubit>().resetCounter();
              ...
              actions: [
                IconButton(
                  onPressed: () {
                    context.read<Khatira28Cubit>().decreaseFontSize();
                  },
                ...
                IconButton(
                  onPressed: () {
                    context.read<Khatira28Cubit>().increaseFontSize();
                  },
                ...
                children: [
                  Expanded(
                    child: GenericCustomTextSlider(
                      cubit: context.read<Khatira28Cubit>(),
