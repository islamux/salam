...
import 'package:elm/view/widget/custom_text_slider/custom_text_slider_elm9.dart';
import 'package:flutter/material.dart';
import 'package:get/get.dart';

class Elm9 extends StatelessWidget {
  const Elm9({super.key});

  @override
  Widget build(BuildContext context) {
    final Elm9ControllerImp controllerAs =
        Get.find<Elm9ControllerImp>();
    //Elm9ControllerImp controllerAs = Get.put(AthkarSabahControllerImp());
    return Scaffold(
      appBar: AppBar(
        ...
        leading: GestureDetector(
          onTap: () {
            ...
            Get.find<Elm9ControllerImp>().resetCounter();
