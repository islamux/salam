...
import 'package:khatir/cubit/elm_cubits/elm_9_cubit.dart';
...
class Elm9Page extends StatelessWidget {
  ...
  const Elm9Page({super.key, this.initialPage});

  @override
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) {
        final cubit = Elm9Cubit();
                ...
                children: [
                  Expanded(
                    child: GenericCustomTextSlider( // Changed
                      cubit: context.read<Elm9Cubit>(),
                      dataList: elmList9NewOrder,
