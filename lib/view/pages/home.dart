import 'package:elm/cubit/home_cubit.dart'; // Import the HomeCubit
                      ...
                      child: Column(
                        ...
                        children: [
                          CustomButton(
                            ...
                            onPressed: () {
                              context.read<HomeCubit>().goToElmPre();
                            },
                          ...
                          CustomButton(
                            ...
                            onPressed: () {
                              context.read<HomeCubit>().goToElm1();
                            },
                            icon: const Icon(Icons.menu_book),
                          ),
                          CustomButton(
                            ...
                            onPressed: () {
                              context.read<HomeCubit>().goToElm2();
                            },
                            icon: const Icon(Icons.menu_book),
                          ),
                          CustomButton(
                            ...
                            onPressed: () {
                              context.read<HomeCubit>().goToElm3();
                            },
                            icon: const Icon(Icons.menu_book),
                          ),
                          CustomButton(
                            ...
                            onPressed: () {
                              context.read<HomeCubit>().goToElm4();
                            },
                            icon: const Icon(Icons.menu_book),
                          ),
                          CustomButton(
                            customText: "  (5)   العدل",
                            onPressed: () {
                              context.read<HomeCubit>().goToElm5();
                            },
                            icon: const Icon(Icons.menu_book),
                          ),
                          CustomButton(
                            ...
                            onPressed: () {
                              context.read<HomeCubit>().goToElm6();
                            },
                            icon: const Icon(Icons.menu_book),
                          ),
                          CustomButton(
                            ...
                            onPressed: () {
                              context.read<HomeCubit>().goToElm7();
                            },
                            icon: const Icon(Icons.menu_book),
                          ),
                          CustomButton(
                            ...
                            onPressed: () {
                              context.read<HomeCubit>().goToElm8();
                            },
                            icon: const Icon(Icons.menu_book),
                          ),
                          CustomButton(
                            ...
                            onPressed: () {
                              context.read<HomeCubit>().goToElm9();
                            },
                            icon: const Icon(Icons.menu_book),
                          ),
                          CustomButton(
                            ...
                            onPressed: () {
                              context.read<HomeCubit>().goToElm10();
                            },
                            icon: const Icon(Icons.menu_book),
                          ),
                          CustomButton(
                            customText: " (11)   الرزق",
                            onPressed: () {
                              context.read<HomeCubit>().goToElm11();
                            },
                            icon: const Icon(Icons.menu_book),
                          ),
                          CustomButton(
                            ...
                            onPressed: () {
                              context.read<HomeCubit>().goToElm12();
                            },
                            icon: const Icon(Icons.menu_book),
                          ),
                          CustomButton(
                            ...
                            onPressed: () {
                              context.read<HomeCubit>().goToElm13();
                            },
                            icon: const Icon(Icons.menu_book),
                          ),
                          CustomButton(
                            ...
                            onPressed: () {
                              context.read<HomeCubit>().goToElm14();
                            },
                            icon: const Icon(Icons.menu_book),
                          ),
                          CustomButton(
                            ...
                            onPressed: () {
                              context.read<HomeCubit>().goToElm15();
                            },
                            icon: const Icon(Icons.menu_book),
                          ),
                          CustomButton(
                            ...
                            onPressed: () {
                              context.read<HomeCubit>().goToElm16();
                            },
                            icon: const Icon(Icons.menu_book),
                          ),
                          CustomButton(
                            ...
                            onPressed: () {
                              context.read<HomeCubit>().goToElm17();
                            },
                            icon: const Icon(Icons.menu_book),
                          ),
                          CustomButton(
                            ...
                            onPressed: () {
                              context.read<HomeCubit>().goToElm18();
                            },
                            icon: const Icon(Icons.menu_book),
                          ),
                          CustomButton(
                            ...
                            onPressed: () {
                              context.read<HomeCubit>().goToElm19();
                            },
                            icon: const Icon(Icons.menu_book),
                          ),
                          CustomButton(
                            ...
                            onPressed: () {
                              context.read<HomeCubit>().goToElm20();
                            },
                            icon: const Icon(Icons.menu_book),
                          ),
                          CustomButton(
                            customText: " (21)  الصبر ",
                            onPressed: () {
                              context.read<HomeCubit>().goToElm21();
                            },
                            icon: const Icon(Icons.menu_book),
                          ),
                          CustomButton(
                            ...
                            onPressed: () {
                              context.read<HomeCubit>().goToElm23();
                            },
                            icon: const Icon(Icons.menu_book),
                          ),
                          CustomButton(
                            ...
                            onPressed: () {
                              context.read<HomeCubit>().goToElm22();
                            },
                            icon: const Icon(Icons.menu_book),
                          ),
                        ],
