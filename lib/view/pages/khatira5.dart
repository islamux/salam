...
class Khatira5Page extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) {
        final cubit = Khatira5Cubit();
        if (initialPage != null && initialPage! > 0) {
          cubit.goToPageAfterBuild(initialPage!);
        }
        return cubit;
      }, // Provide Khatira5Cubit
      child: Builder(
        builder: (context) {
          return Scaffold(
            appBar: AppBar(
                  ...
                  IconButton(
                    ...
                    onPressed: () {
                      final currentPageIndex =
                          context.read<Khatira5Cubit>().currentPageIndex;
                      context.read<Khatira5Cubit>().customShareContent(
                          currentPageIndex, khatiraList5NewOrder);
                    },
            ...
            body: SafeArea(
              child: GestureDetector(
                ...
                child: GenericCustomTextSlider(
                  // Changed
                  cubit: context.read<Khatira5Cubit>(),
