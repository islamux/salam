          ...
          return Scaffold(
            appBar: AppBar(
                  ...
                  IconButton(
                    onPressed: () {
                      final currentPageIndex =
                          context.read<Khatira30Cubit>().currentPageIndex;
                      context.read<Khatira30Cubit>().customShareContent(
                          currentPageIndex, khatiraList30NewOrder);
                    },
              ...
              leading: GestureDetector(
                onTap: () {
                  context.read<Khatira30Cubit>().resetCounter();
              ...
              actions: [
                IconButton(
                  onPressed: () {
                    context.read<Khatira30Cubit>().decreaseFontSize();
                  },
                ...
                IconButton(
                  onPressed: () {
                    context.read<Khatira30Cubit>().increaseFontSize();
                  },
                ...
                children: [
                  Expanded(
                    child: GenericCustomTextSlider(
                      cubit: context.read<Khatira30Cubit>(),
