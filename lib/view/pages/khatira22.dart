          ...
          return Scaffold(
            appBar: AppBar(
                  ...
                  IconButton(
                    ...
                    onPressed: () {
                      final currentPageIndex =
                          context.read<Khatira22Cubit>().currentPageIndex;
                      context.read<Khatira22Cubit>().customShareContent(
                          currentPageIndex, khatiraList22NewOrder);
                    },
              ...
              leading: GestureDetector(
                onTap: () {
                  context.read<Khatira22Cubit>().resetCounter(); // Reset counter
                  // Navigator.pushNamed(
                ...
                children: [
                  Expanded(
                    child: GenericCustomTextSlider( // Changed
                      cubit: context.read<Khatira22Cubit>(),
