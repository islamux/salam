import 'package:elm/cubit/pages_cubits/elm19_cubit.dart'; // Import the Elm19Cubit
          ...
          return Scaffold(
            appBar: AppBar(
              ...
              actions: [
                IconButton(
                  onPressed: () {
                    context.read<Elm19Cubit>().decreaseFontSize(); // Decrease font size
                  },
                ...
                IconButton(
                  onPressed: () {
                    context.read<Elm19Cubit>().increaseFontSize(); // Increase font size
                  },
            ...
            body: const SafeArea(
              child: Column(
                children: [
                  Expanded(
                    child: CustomTextSliderElm19(), // Custom text slider
                  ),
