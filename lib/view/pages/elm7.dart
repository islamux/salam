import 'package:elm/cubit/pages_cubits/elm7_cubit.dart'; // Import Elm7Cubit
          ...
          return Scaffold(
            appBar: AppBar(
              ...
              leading: GestureDetector(
                onTap: () {
                  context.read<Elm7Cubit>().resetCounter(); // Reset counter before going back
              ...
              actions: [
                IconButton(
                  onPressed: () {
                    context.read<Elm7Cubit>().decreaseFontSize(); // Decrease font size
                  },
                ...
                IconButton(
                  onPressed: () {
                    context.read<Elm7Cubit>().increaseFontSize(); // Increase font size
                  },
