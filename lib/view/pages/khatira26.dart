...
import 'package:khatir/cubit/khatira_cubits/khatira_26_cubit.dart';
          ...
          return Scaffold(
            appBar: AppBar(
                  ...
                  IconButton(
                    ...
                    onPressed: () {
                      final currentPageIndex =
                          context.read<Khatira26Cubit>().currentPageIndex;
                      context.read<Khatira26Cubit>().customShareContent(
                          currentPageIndex, khatiraList26NewOrder);
                    },
              ...
              leading: GestureDetector(
                onTap: () {
                  context.read<Khatira26Cubit>().resetCounter(); // Reset counter
                  // Navigator.pushNamed(
                ...
                children: [
                  Expanded(
                    child: GenericCustomTextSlider( // Changed
                      cubit: context.read<Khatira26Cubit>(),
                      dataList: khatiraList26NewOrder,
