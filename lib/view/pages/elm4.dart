import 'package:elm/cubit/pages_cubits/elm4_cubit.dart'; // Import the Elm4Cubit
          ...
          return Scaffold(
            appBar: AppBar(
              ...
              leading: GestureDetector(
                onTap: () {
                  context.read<Elm4Cubit>().resetCounter(); // Reset counter before going back
              ...
              actions: [
                IconButton(
                  onPressed: () {
                    context.read<Elm4Cubit>().decreaseFontSize(); // Decrease font size
                  },
                ...
                IconButton(
                  onPressed: () {
                    context.read<Elm4Cubit>().increaseFontSize(); // Increase font size
                  },
