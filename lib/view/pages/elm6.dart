...
import 'package:khatir/cubit/elm_cubits/elm_6_cubit.dart';
...
class Elm6Page extends StatelessWidget {
  ...
  const Elm6Page({super.key, this.initialPage});

  @override
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) {
        final cubit = Elm6Cubit();
            ...
            body: SafeArea(
              child: GestureDetector( // GestureDetector can likely be removed if not needed for other purposes
                ...
                child: GenericCustomTextSlider( // Changed
                  cubit: context.read<Elm6Cubit>(),
                  dataList: elmList6NewOrder,
