import 'package:elm/cubit/pages_cubits/elm20_cubit.dart'; // Import the Elm20Cubit
...
class Elm20Page extends StatelessWidget {
  const Elm20Page({super.key});

  @override
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => Elm20Cubit(), // Provide Elm20Cubit
      child: Builder(
        builder: (context) {
          return Scaffold(
            appBar: AppBar(
              ...
              actions: [
                IconButton(
                  onPressed: () {
                    context.read<Elm20Cubit>().decreaseFontSize(); // Decrease font size
                  },
                ...
                IconButton(
                  onPressed: () {
                    context.read<Elm20Cubit>().increaseFontSize(); // Increase font size
                  },
            ...
            body: const SafeArea(
              child: Column(
                children: [
                  Expanded(
                    child: CustomTextSliderElm20(), // Custom text slider
                  ),
