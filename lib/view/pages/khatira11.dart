...
class Khatira11Page extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) {
        final cubit = Khatira11Cubit();
        if (initialPage != null && initialPage! > 0) {
          cubit.goToPageAfterBuild(initialPage!);
        }
        return cubit;
      }, // Provide Khatira11Cubit
      child: Builder(
        builder: (context) {
          return Scaffold(
            appBar: AppBar(
                  ...
                  IconButton(
                    ...
                    onPressed: () {
                      final currentPageIndex =
                          context.read<Khatira11Cubit>().currentPageIndex;
                      context.read<Khatira11Cubit>().customShareContent(
                          currentPageIndex, khatiraList11NewOrder);
                    },
              ...
              leading: GestureDetector(
                onTap: () {
                  context.read<Khatira11Cubit>().resetCounter(); // Reset counter
                ...
                children: [
                  Expanded(
                    child: GenericCustomTextSlider( // Changed
                      cubit: context.read<Khatira11Cubit>(),
