...
import 'package:elm/cubit/elm_cubits/elm_26_cubit.dart';
...
class CustomTextSliderElm26 extends StatelessWidget {
  const CustomTextSliderElm26({super.key});

  @override
  Widget build(BuildContext context) {
    return BlocBuilder<Elm26Cubit, BasePageState>(
      // Use BlocBuilder to listen for state changes
      builder: (context, state) {
        Elm26Cubit cubit = context.read<Elm26Cubit>(); // Access the Elm23Cubit
          ...
          children: [
            ...
            SizedBox(
              ...
              child: PageView.builder(
                ...
                itemCount: elmList26NewOrder.length, // Total number of pages
                itemBuilder: (context, i) {
                  // Determine which page content to display
                  List<TextSpan> pageTexts = getPageTexts(i, elmList26NewOrder);
                ...
                children: [
                  Expanded(
                    child: Slider(
                      ...
                      min: 0,
                      max: elmList26NewOrder.length.toDouble() -
                  ...
                  Text(
                    '${(cubit.currentPageIndex ?? 0) + 1} / ${elmList26NewOrder.length}', // Current page number display
