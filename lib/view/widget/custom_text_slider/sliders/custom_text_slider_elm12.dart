...
import 'package:elm/cubit/pages_cubits/cubits/elm_cubits/elm_12_cubit.dart';
...
class CustomTextSliderElm12 extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<Elm12Cubit, BasePageState>(
      // Use BlocBuilder to listen for state changes
      builder: (context, state) {
        Elm12Cubit cubit = context.read<Elm12Cubit>(); // Access the Elm10Cubit
          ...
          children: [
            ...
            SizedBox(
              ...
              child: PageView.builder(
                ...
                itemCount: elmList12New.length, // Total number of pages
                itemBuilder: (context, i) {
                  // Determine which page content to display
                  List<TextSpan> pageTexts =
                      whichPageToGetInElm12New(i, elmList12New);
                ...
                children: [
                  Expanded(
                    child: Slider(
                      ...
                      min: 0,
                      max: elmList12New.length.toDouble() -
                  ...
                  Text(
                    '${(cubit.currentPageIndex ?? 0) + 1} / ${elmList12New.length}', // Current page number display
