          ...
          children: [
            ...
            SizedBox(
              ...
              child: PageView.builder(
                ...
                itemCount: elmList15NewOrder.length, // Total number of pages
                itemBuilder: (context, i) {
                  // Determine which page content to display
                  List<TextSpan> pageTexts = getPageTexts(i, elmList15NewOrder);
                ...
                children: [
                  Expanded(
                    child: Slider(
                      ...
                      min: 0,
                      max: elmList15NewOrder.length.toDouble() -
                  ...
                  Text(
                    '${(cubit.currentPageIndex ?? 0) + 1} / ${elmList15NewOrder.length}', // Current page number display
