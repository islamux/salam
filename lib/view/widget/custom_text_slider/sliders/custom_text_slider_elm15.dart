...
import 'package:elm/cubit/pages_cubits/cubits/elm_cubits/elm_15_cubit.dart';
...
class CustomTextSliderElm15 extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<Elm15Cubit, BasePageState>(
      // Use BlocBuilder to listen for state changes
      builder: (context, state) {
        Elm15Cubit cubit = context.read<Elm15Cubit>(); // Access the Elm15Cubit
          ...
          children: [
            ...
            SizedBox(
              ...
              child: PageView.builder(
                ...
                itemCount: elmList15New.length, // Total number of pages
                ...
                children: [
                  Expanded(
                    child: Slider(
                      ...
                      min: 0,
                      max: elmList15New.length.toDouble() -
                  ...
                  Text(
                    '${(cubit.currentPageIndex ?? 0) + 1} / ${elmList15New.length}', // Current page number display
