...
import 'package:elm/cubit/pages_cubits/cubits/elm_cubits/elm_21_cubit.dart';
...
class CustomTextSliderElm21 extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<Elm21Cubit, BasePageState>(
      // Use BlocBuilder to listen for state changes
      builder: (context, state) {
        Elm21Cubit cubit = context.read<Elm21Cubit>(); // Access the Elm10Cubit
          ...
          children: [
            ...
            SizedBox(
              ...
              child: PageView.builder(
                ...
                itemCount: elmList21New.length, // Total number of pages
                ...
                children: [
                  Expanded(
                    child: Slider(
                      ...
                      min: 0,
                      max: elmList21New.length.toDouble() -
                  ...
                  Text(
                    '${(cubit.currentPageIndex ?? 0) + 1} / ${elmList21New.length}', // Current page number display
