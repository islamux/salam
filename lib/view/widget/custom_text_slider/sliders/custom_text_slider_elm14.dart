import 'package:elm/core/data/model/elm_lists/elm_list_14_new.dart';
...
import 'package:elm/cubit/pages_cubits/cubits/elm_cubits/elm_14_cubit.dart';
import 'package:elm/view/widget/custom_text_slider/which_page_to_get/which_page_to_get_in_elm_14_new.dart';
...
class CustomTextSliderElm14 extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<Elm14Cubit, BasePageState>(
      // Use BlocBuilder to listen for state changes
      builder: (context, state) {
        Elm14Cubit cubit = context.read<Elm14Cubit>(); // Access the Elm10Cubit
          ...
          children: [
            ...
            SizedBox(
              ...
              child: PageView.builder(
                ...
                itemCount: elmList14New.length, // Total number of pages
                itemBuilder: (context, i) {
                  // Determine which page content to display
                  List<TextSpan> pageTexts =
                      whichPageToGetInElm14New(i, elmList14New);
                ...
                children: [
                  Expanded(
                    child: Slider(
                      ...
                      min: 0,
                      max: elmList14New.length.toDouble() -
                  ...
                  Text(
                    '${(cubit.currentPageIndex ?? 0) + 1} / ${elmList14New.length}', // Current page number display
