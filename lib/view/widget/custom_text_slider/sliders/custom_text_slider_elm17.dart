...
import 'package:elm/cubit/pages_cubits/cubits/elm_cubits/elm_17_cubit.dart';
...
class CustomTextSliderElm17 extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<Elm17Cubit, BasePageState>(
      // Use BlocBuilder to listen for state changes
      builder: (context, state) {
        Elm17Cubit cubit = context.read<Elm17Cubit>(); // Access the Elm10Cubit
