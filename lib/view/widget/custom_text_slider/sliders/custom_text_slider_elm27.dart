...
import 'package:elm/cubit/elm_cubits/elm_27_cubit.dart';
...
class CustomTextSliderElm27 extends StatelessWidget {
  const CustomTextSliderElm27({super.key});

  @override
  Widget build(BuildContext context) {
    return BlocBuilder<Elm27Cubit, BasePageState>(
      // Use BlocBuilder to listen for state changes
      builder: (context, state) {
        Elm27Cubit cubit = context.read<Elm27Cubit>(); // Access the Elm23Cubit
          ...
          children: [
            ...
            SizedBox(
              ...
              child: PageView.builder(
                ...
                itemCount: elmList27NewOrder.length, // Total number of pages
                itemBuilder: (context, i) {
                  // Determine which page content to display
                  List<TextSpan> pageTexts = getPageTexts(i, elmList27NewOrder);
                ...
                children: [
                  Expanded(
                    child: Slider(
                      ...
                      min: 0,
                      max: elmList27NewOrder.length.toDouble() -
                  ...
                  Text(
                    '${(cubit.currentPageIndex ?? 0) + 1} / ${elmList27NewOrder.length}', // Current page number display
