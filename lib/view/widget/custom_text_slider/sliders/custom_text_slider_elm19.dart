...
import 'package:elm/cubit/pages_cubits/cubits/elm_cubits/elm_19_cubit.dart';
          ...
          children: [
            ...
            SizedBox(
              ...
              child: PageView.builder(
                ...
                itemCount: elmList19New.length, // Total number of pages
                ...
                children: [
                  Expanded(
                    child: Slider(
                      ...
                      min: 0,
                      max: elmList19New.length.toDouble() -
                  ...
                  Text(
                    '${(cubit.currentPageIndex ?? 0) + 1} / ${elmList19New.length}', // Current page number display
