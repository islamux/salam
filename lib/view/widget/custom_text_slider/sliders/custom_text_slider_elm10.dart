...
import 'package:elm/cubit/pages_cubits/cubits/elm_cubits/elm_10_cubit.dart';
...
class CustomTextSliderElm10 extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<Elm10Cubit, BasePageState>(
      // Use BlocBuilder to listen for state changes
      builder: (context, state) {
        Elm10Cubit cubit = context.read<Elm10Cubit>(); // Access the Elm10Cubit
          ...
          children: [
            ...
            SizedBox(
              ...
              child: PageView.builder(
                ...
                itemCount: elmList10New.length, // Total number of pages
                itemBuilder: (context, i) {
                  // Determine which page content to display
                  List<TextSpan> pageTexts =
                      whichPageToGetInElm10New(i, elmList10New);
                ...
                children: [
                  Expanded(
                    child: Slider(
                      ...
                      min: 0,
                      max: elmList10New.length.toDouble() -
                  ...
                  Text(
                    '${(cubit.currentPageIndex ?? 0) + 1} / ${elmList10New.length}', // Current page number display
