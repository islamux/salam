          ...
          children: [
            ...
            SizedBox(
              ...
              child: PageView.builder(
                ...
                itemCount: elmList10NewOrder.length, // Total number of pages
                itemBuilder: (context, i) {
                  // Determine which page content to display
                  List<TextSpan> pageTexts = getPageTexts(i, elmList10NewOrder);
                ...
                children: [
                  Expanded(
                    child: Slider(
                      ...
                      min: 0,
                      max: elmList10NewOrder.length.toDouble() -
                  ...
                  Text(
                    '${(cubit.currentPageIndex ?? 0) + 1} / ${elmList10NewOrder.length}', // Current page number display
