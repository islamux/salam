...
class CustomTextSliderElm24 extends StatelessWidget {
  const CustomTextSliderElm24({super.key});

  @override
  Widget build(BuildContext context) {
    return BlocBuilder<Elm24Cubit, BasePageState>(
      // Use BlocBuilder to listen for state changes
      builder: (context, state) {
        Elm24Cubit cubit = context.read<Elm24Cubit>(); // Access the Elm23Cubit
          ...
          children: [
            ...
            SizedBox(
              ...
              child: PageView.builder(
                ...
                itemCount: elmList24NewOrder.length, // Total number of pages
                itemBuilder: (context, i) {
                  // Determine which page content to display
                  List<TextSpan> pageTexts = getPageTexts(i, elmList24NewOrder);
                ...
                children: [
                  Expanded(
                    child: Slider(
                      ...
                      min: 0,
                      max: elmList24NewOrder.length.toDouble() -
                  ...
                  Text(
                    '${(cubit.currentPageIndex ?? 0) + 1} / ${elmList24NewOrder.length}', // Current page number display
