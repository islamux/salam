                ...
                children: [
                  Expanded(
                    child: Slider(
                      ...
                      min: 0,
                      max: elmList13New.length.toDouble() - 1,
                    ),
                  ),
                  Text(
                    '${controller.currentPageIndex + 1} / ${elmList13New.length}',
...
//                     '${controllerAs.currentPageIndex + 1.toInt()} / ${elmList13New.length}',
