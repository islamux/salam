...
import 'package:elm/cubit/pages_cubits/cubits/elm_cubits/elm_16_cubit.dart';
          ...
          children: [
            ...
            SizedBox(
              ...
              child: PageView.builder(
                ...
                itemCount: elmList16New.length, // Total number of pages
                ...
                children: [
                  Expanded(
                    child: Slider(
                      ...
                      min: 0,
                      max: elmList16New.length.toDouble() -
                  ...
                  Text(
                    '${(cubit.currentPageIndex ?? 0) + 1} / ${elmList16New.length}', // Current page number display
