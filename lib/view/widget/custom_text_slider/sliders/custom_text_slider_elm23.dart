          ...
          children: [
            ...
            SizedBox(
              ...
              child: PageView.builder(
                ...
                itemCount: elmList23NewOrder.length, // Total number of pages
                itemBuilder: (context, i) {
                  // Determine which page content to display
                  List<TextSpan> pageTexts = getPageTexts(i, elmList23NewOrder);
                ...
                children: [
                  Expanded(
                    child: Slider(
                      ...
                      min: 0,
                      max: elmList23NewOrder.length.toDouble() -
                  ...
                  Text(
                    '${(cubit.currentPageIndex ?? 0) + 1} / ${elmList23NewOrder.length}', // Current page number display
