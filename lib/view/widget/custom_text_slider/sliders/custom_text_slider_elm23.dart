...
import 'package:elm/cubit/pages_cubits/cubits/elm_cubits/elm_23_cubit.dart';
...
class CustomTextSliderElm23 extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<Elm23Cubit, BasePageState>(
      // Use BlocBuilder to listen for state changes
      builder: (context, state) {
        Elm23Cubit cubit = context.read<Elm23Cubit>(); // Access the Elm23Cubit
          ...
          children: [
            ...
            SizedBox(
              ...
              child: PageView.builder(
                ...
                itemCount: elmList23New.length, // Total number of pages
                ...
                children: [
                  Expanded(
                    child: Slider(
                      ...
                      min: 0,
                      max: elmList23New.length.toDouble() -
                  ...
                  Text(
                    '${(cubit.currentPageIndex ?? 0) + 1} / ${elmList23New.length}', // Current page number display
