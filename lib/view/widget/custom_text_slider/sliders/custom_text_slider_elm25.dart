...
class CustomTextSliderElm25 extends StatelessWidget {
  const CustomTextSliderElm25({super.key});

  @override
  Widget build(BuildContext context) {
    return BlocBuilder<Elm25Cubit, BasePageState>(
      // Use BlocBuilder to listen for state changes
      builder: (context, state) {
        Elm25Cubit cubit = context.read<Elm25Cubit>(); // Access the Elm23Cubit
          ...
          children: [
            ...
            SizedBox(
              ...
              child: PageView.builder(
                ...
                itemCount: elmList25NewOrder.length, // Total number of pages
                itemBuilder: (context, i) {
                  // Determine which page content to display
                  List<TextSpan> pageTexts = getPageTexts(i, elmList25NewOrder);
                ...
                children: [
                  Expanded(
                    child: Slider(
                      ...
                      min: 0,
                      max: elmList25NewOrder.length.toDouble() -
                  ...
                  Text(
                    '${(cubit.currentPageIndex ?? 0) + 1} / ${elmList25NewOrder.length}', // Current page number display
