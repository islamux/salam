...
import 'package:elm/view/widget/custom_text_slider/which_page_to_get/which_page_to_get_in_elm_1_new.dart';
            ...
            SizedBox(
              ...
              child: PageView.builder(
                ...
                itemBuilder: (context, i) {
                  ...
                  pageTexts = whichPageToGetInElm1New(i, elmList1New);
            ...
            Positioned(
              ...
              child: Row(
                ...
                children: [
                  ...
                  Text(
                    '${controller.currentPageIndex + 1} / ${elmList1New.length}',
