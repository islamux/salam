...
class CustomTextSliderElm12 extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final Elm12ControllerImp controllerAs =
        Get.find<Elm12ControllerImp>();
                            ...
                            builder: (controllerAs) {
                              return Text(
                                ...
                                style: //AppTheme.goldenTheme.textTheme.bodyLarge,
                                  ...
                                  // widgt not all page
                                  fontSize:
                                      //Get.find<Elm12ControllerImp>().fontSize,
              ...
              child: Row(
                ...
                children: [
                  ...
                  Text(
                    ...
                    '${controllerAs.currentPageIndex+1.toInt()} / ${elmList12.length}',
