...
import 'package:khatir/features/khatira/data/static/text/khatira_text_ders_three.dart';

List<KhatiraModelNewOrder> khatiraList3NewOrder = [
  // 1
  KhatiraModelNewOrder(
    titles: [
      KhatiraTextDersThree.titleThreeOne,
    ],
    texts: [
    ...
    ayahs: [
      ...
      KhatiraTextDersThree.ayahHadithThreeOne_2,
      KhatiraTextDersThree.ayahHadithThreeTwo_1,
      KhatiraTextDersThree.ayahHadithThreeThree_1,
    ],
    order: [
      EnOrder.titles,
      EnOrder.texts,
  ...
  KhatiraModelNewOrder(
    ...
    ayahs: [
      ...
      KhatiraTextDersThree.ayahHadithThreeNine_2,
    ],
    order: [
      EnOrder.subtitles,
      EnOrder.texts,
