...
import 'package:khatir/features/khatira/data/static/text/khatira_text_ders_twenty_seven.dart';

List<KhatiraModelNewOrder> khatiraList27NewOrder = [
  // 1
  KhatiraModelNewOrder(
    ...
    ayahs: [
      ...
      KhatiraTextTwentySeven.ayahHadithTwentySevenPageOne_2,
    ],
    order: [
      EnOrder.subtitles,
      EnOrder.texts,
  ...
  KhatiraModelNewOrder(
    ...
    ayahs: [
      ...
      KhatiraTextTwentySeven.ayahHadithTwentySevenPageTwo_2,
      KhatiraTextTwentySeven.ayahHadithTwentySevenPageTwo_3,
    ],
    order: [
      EnOrder.texts,
      EnOrder.ayahs,
  ...
  KhatiraModelNewOrder(
    ...
    ayahs: [
      ...
      KhatiraTextTwentySeven.ayahHadithTwentySevenPageThree_2,
    ],
    order: [
      EnOrder.subtitles,
      EnOrder.texts,
  ...
  KhatiraModelNewOrder(
    subtitles: [
      KhatiraTextTwentySeven.subtitleTwentySevenPageFour_1,
    ],
    ayahs: [
  ...
  KhatiraModelNewOrder(
    subtitles: [
      KhatiraTextTwentySeven.subtitleTwentySevenPageSix_1,
  ...
  KhatiraModelNewOrder(
    subtitles: [
      KhatiraTextTwentySeven.subtitleTwentySevenPageSeven_1,
      KhatiraTextTwentySeven.subtitleTwentySevenPageSeven_2,
    ],
    ayahs: [
  ...
  KhatiraModelNewOrder(
    ...
    ayahs: [
      ...
      KhatiraTextTwentySeven.ayahHadithTwentySevenPageEight_2,
      KhatiraTextTwentySeven.ayahHadithTwentySevenPageEight_3,
      KhatiraTextTwentySeven.ayahHadithTwentySevenPageEight_4,
      KhatiraTextTwentySeven.ayahHadithTwentySevenPageEight_5,
      KhatiraTextTwentySeven.ayahHadithTwentySevenPageEight_6,
    ],
    order: [
      EnOrder.subtitles,
      EnOrder.texts,
  ...
  KhatiraModelNewOrder(
    subtitles: [
      KhatiraTextTwentySeven.subtitleTwentySevenPageTen_1,
  ...
  KhatiraModelNewOrder(
    subtitles: [
      KhatiraTextTwentySeven.subtitleTwentySevenPageEleven_1,
  ...
  KhatiraModelNewOrder(
    subtitles: [
      KhatiraTextTwentySeven.subtitleTwentySevenPageTwelve_1,
      KhatiraTextTwentySeven.subtitleTwentySevenPageThirteen_1,
    ],
    ayahs: [
      KhatiraTextTwentySeven.ayahHadithTwentySevenPageTwelve_1,
      KhatiraTextTwentySeven.ayahHadithTwentySevenPageTwelve_2,
      KhatiraTextTwentySeven.ayahHadithTwentySevenPageThirteen_1,
      KhatiraTextTwentySeven.ayahHadithTwentySevenPageThirteen_2,
      KhatiraTextTwentySeven.ayahHadithTwentySevenPageThirteen_3,
  ...
  KhatiraModelNewOrder(
    ...
    subtitles: [
      ...
      KhatiraTextTwentySeven.subtitleTwentySevenPageFourteen_2,
    ],
    ayahs: [
      KhatiraTextTwentySeven.ayahHadithTwentySevenPageFourteen_1,
      KhatiraTextTwentySeven.ayahHadithTwentySevenPageFourteen_2,
    ],
    order: [
      EnOrder.texts,
      EnOrder.subtitles,
  ...
  KhatiraModelNewOrder(
    subtitles: [
      ...
      KhatiraTextTwentySeven.subtitleTwentySevenPageFifteen_2,
    ],
    ayahs: [
      KhatiraTextTwentySeven.ayahHadithTwentySevenPageFifteen_1,
  ...
  KhatiraModelNewOrder(
    subtitles: [
      KhatiraTextTwentySeven.subtitleTwentySevenPageSixteen_1,
      KhatiraTextTwentySeven.subtitleTwentySevenPageSixteen_2,
    ],
    ayahs: [
      KhatiraTextTwentySeven.ayahHadithTwentySevenPageSixteen_1,
      KhatiraTextTwentySeven.ayahHadithTwentySevenPageSixteen_2,
      KhatiraTextTwentySeven.ayahHadithTwentySevenPageSixteen_3,
  ...
  KhatiraModelNewOrder(
    subtitles: [
      KhatiraTextTwentySeven.subtitleTwentySevenPageSeventeen_1,
  ...
  KhatiraModelNewOrder(
    ...
    ayahs: [
      ...
      KhatiraTextTwentySeven.ayahHadithTwentySevenPageEighteen_2,
      KhatiraTextTwentySeven.ayahHadithTwentySevenPageEighteen_3,
      KhatiraTextTwentySeven.ayahHadithTwentySevenPageEighteen_4,
      KhatiraTextTwentySeven.ayahHadithTwentySevenPageEighteen_5,
    ],
    order: [
      EnOrder.texts,
      EnOrder.ayahs,
  ...
  KhatiraModelNewOrder(
    subtitles: [
      KhatiraTextTwentySeven.subtitleTwentySevenPageNineteen_1,
      KhatiraTextTwentySeven.subtitleTwentySevenPageNineteen_2,
      KhatiraTextTwentySeven.subtitleTwentySevenPageNineteen_3,
    ],
    ayahs: [
      KhatiraTextTwentySeven.ayahHadithTwentySevenPageNineteen_1,
      KhatiraTextTwentySeven.ayahHadithTwentySevenPageNineteen_2,
  ...
  KhatiraModelNewOrder(
    subtitles: [
      ...
      KhatiraTextTwentySeven.subtitleTwentySevenPageTwentyOne_1,
      KhatiraTextTwentySeven.subtitleTwentySevenPageTwentyOne_2,
    ],
    ayahs: [
