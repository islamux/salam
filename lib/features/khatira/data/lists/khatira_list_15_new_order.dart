...
import 'package:khatir/features/khatira/data/static/text/khatira_text_ders_fifteen.dart';

List<KhatiraModelNewOrder> khatiraList15NewOrder = [
  // 1
  KhatiraModelNewOrder(
    titles: [
      KhatiraTextDersFifteen.titleFifteenOne,
    ],
    ayahs: [
  ...
  KhatiraModelNewOrder(
    ...
    footer: KhatiraTextDersFifteen.footerFifteenTwo,
    order: [
      EnOrder.texts,
      EnOrder.ayahs,
      EnOrder.footer,
  ...
  KhatiraModelNewOrder(
    ayahs: [
      KhatiraTextDersFifteen.ayahHadithFifteenFour_1,
  ...
  KhatiraModelNewOrder(
    ...
    footer: KhatiraTextDersFifteen.footerFifteenSix,
    order: [
      EnOrder.texts,
      EnOrder.ayahs,
      EnOrder.footer,
  ...
  KhatiraModelNewOrder(
    ayahs: [
      KhatiraTextDersFifteen.ayahHadithFifteenFourteen_1,
      KhatiraTextDersFifteen.ayahHadithFifteenFifteen_1,
