...
List<ElmModel> elmList17 = [
  // page 1
  ElmModel(
    text: ElmTextDersSeventeen.elmTextSeventeenOne_1,
    ayah: ElmTextDersSeventeen.ayahHadithSeventeenOne_1,
    text2: ElmTextDersSeventeen.elmTextSeventeenOne_2,
  ...
  ElmModel(
    ...
    ayah: ElmTextDersSeventeen.ayahHadithSeventeenFour_1,
    text2: ElmTextDersSeventeen.elmTextSeventeenFour_2,
  ),
  // page 5
  ElmModel(
    text: ElmTextDersSeventeen.elmTextSeventeenFive_1,
    text2: ElmTextDersSeventeen.elmTextSeventeenFive_2,
  ),
  // page 6
  ElmModel(
    text: ElmTextDersSeventeen.elmTextSeventeenSix_1,
    text2: ElmTextDersSeventeen.elmTextSeventeenSix_2,
  ...
  ElmModel(
    ...
    ayah: ElmTextDersSeventeen.ayahHadithSeventeenSeven_1,
    text2: ElmTextDersSeventeen.elmTextSeventeenSeven_2,
    ayah2: ElmTextDersSeventeen.ayahHadithSeventeenSeven_2,
  ...
  ElmModel(
    ...
    text: ElmTextDersSeventeen.elmTextSeventeenNine_1,
  ...
  ElmModel(
    ...
    ayah: ElmTextDersSeventeen.ayahHadithSeventeenTen_1,
  ),
  // page 11
  ElmModel(
    ayah: ElmTextDersSeventeen.ayahHadithSeventeenEleven_1,
    text: ElmTextDersSeventeen.elmTextSeventeenEleven_1,
  )
];
