...
// page 13
  ElmModelNew(
    texts: [
      ElmTextNineteen.elmTextNineteenTherteen_1,
      ElmTextNineteen.elmTextNineteenTherteen_2,
      ElmTextNineteen.elmTextNineteenTherteen_3,
    ],
    ayahs: [
      ElmTextNineteen.ayahHadithNineteenThertten_1,
      ElmTextNineteen.ayahHadithNineteenTherteen_2,
    ],
    subtitles: [
      ElmTextNineteen.subtitleNineteenTherteen_1,
    ],
  ),
// page 14
  ElmModelNew(
...
// page 16
  ElmModelNew(
    titles: [
      ElmTextNineteen.titleNinteenSixteen,
    ],
    subtitles: [
