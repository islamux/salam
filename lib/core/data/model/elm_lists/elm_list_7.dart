...
List<ElmModel> elmList7 = [
  ...
  ElmModel(
    ...
    ayah: ElmTextDersSeven.ayahHadithSevenTen_1,
    text: ElmTextDersSeven.elmTextSevenTen_1,
    ayah2: ElmTextDersSeven.ayahHadithSevenTen_2,
  ...
  ElmModel(
    ...
    ayah: ElmTextDersSeven.ayahHadithSevenEleven_1,
    text2: ElmTextDersSeven.elmTextSevenEleven_2,
    ayah2: ElmTextDersSeven.ayahHadithSevenEleven_2,
    text3: ElmTextDersSeven.elmTextSevenEleven_3,
  ),
];
