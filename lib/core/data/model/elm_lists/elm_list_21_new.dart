...
// page 2
  ElmModelNew(
    ...
    texts: [
      ...
      ElmTextTwentyOne.elmTextTwentyOneTwo_2,
    ],
    subtitles: [
  ...
  ElmModelNew(
    ayahs: [
      ...
      ElmTextTwentyOne.ayahHadithTwentyOneThree_4,
    ],
    subtitles: [
  ...
  ElmModelNew(
    ...
    texts: [
      ElmTextTwentyOne.elmtTextTwentyOneFive_1,
  ...
  ElmModelNew(
    ...
    ayahs: [
      ...
      ElmTextTwentyOne.elmTextTwentyOneEigth_4,
    ],
  ),
  // page 9
  ElmModelNew(
    ...
    texts: [
      ...
      ElmTextTwentyOne.elmtTextTwentyOneNine_3,
    ],
    subtitles: [
      ElmTextTwentyOne.subtitleTwentyOneNine_1,
    ],
  ),
  // page 10
  ElmModelNew(
  ...
  ElmModelNew(
    ayahs: [
      ElmTextTwentyOne.ayahHadithTwentyOneTherteen_1,
      ElmTextTwentyOne.ayahHadithTwentyOneTherteen_2,
    ],
    texts: [
      ElmTextTwentyOne.elmTextTwentyOneeTherteen_1,
    ],
  ),
  ...
  ElmModelNew(
    ...
    ayahs: [
      ElmTextTwentyOne.ayahHdithTwentyOneFifteen_1,
    ],
  ),
  // page 16
  ElmModelNew(
    ayahs: [
      ...
      ElmTextTwentyOne.elmTextTwentyOneSixteen_4,
    ],
    texts: [
      ...
      ElmTextTwentyOne.ayahHadithTwentyOneSixteen_4,
    ],
  ),
  // page 17
  ElmModelNew(
  ...
  ElmModelNew(
    texts: [
      ElmTextTwentyOne.elmTextTwentyOneNinteen_1,
      ElmTextTwentyOne.elmTextTwentyOneNinteen_2,
      ElmTextTwentyOne.elmTextTwentyOneNinteen_3,
    ],
    ayahs: [
      ElmTextTwentyOne.ayahHadithTwentyOneNinteen_1,
      ElmTextTwentyOne.ayahHadithTwentyOneNinteen_2,
      ElmTextTwentyOne.ayahHadithTwentyOneNinteen_3,
    ],
    subtitles: [
      ElmTextTwentyOne.subtitleTwentyOneNinteen_1,
    ],
  ),
  // page 20
  ElmModelNew(
